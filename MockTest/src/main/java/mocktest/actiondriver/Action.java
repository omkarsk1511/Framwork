...
public class Action extends BaseClass implements ActionInterface {
	...
	/*
	 * @Override public boolean Alert(WebDriver driver) { boolean presentFlag =
	 * false; Alert alert = null;
	 * 
	...
	public boolean Alert(WebDriver driver) {
		...
		// Create WebDriverWait instance to wait for the alert to be present
		...
		try {
			...
			// If no alert is present, log the message
	...
	public String screenShot(WebDriver driver, String filename) {
		String dateName = new SimpleDateFormat("yyyyMMddkkmmss").format(new Date());
	...
	public String getCurrentTime() {
		String currentDate = new SimpleDateFormat("yyyy-MM-dd-kk:mm:ss").format(new Date());
		return currentDate;
	}
